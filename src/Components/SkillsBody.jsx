    ...
    <div className='w-[100%] h-[100%]'>
      <h1 className='text-center font-bold text-3xl pt-[25px] '>Skills</h1>
        <div className='w-[100%] h-[90%] flex justify-center items-center gap-[50px] '>
            <div className='xl:w-[30%] w-[45%] h-[60%] border-[1px] rounded-xl flex p-[15px] items-center flex-col shadow-2xl shadow-cyan-400 '>
            ...
            <div className='xl:w-[30%] w-[45%] h-[60%] border-[1px] rounded-xl flex p-[10px] items-center flex-col shadow-2xl shadow-cyan-400 '>
